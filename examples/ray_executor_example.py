...
Note: This example requires Ray to be installed. You can install it with:
...
try:
    ...
    if "Ray is not installed" in str(e):
        print("Error: Ray is not installed. Please install it with: pip install liteflow[ray]")
        sys.exit(1)
    else:
        raise
...
def main():
    try:
        ...
        print(f"Error: {e}")
        print("This example requires Ray to be installed. You can install it with: pip install liteflow[ray]")
        sys.exit(1)
